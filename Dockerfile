...
RUN dep ensure -v
RUN go build -o cloud-controller-manager-alicloud -ldflags "-X k8s.io/cloud-provider-alibaba-cloud/version.Version=alicloud-cloud-provider" cmd/cloudprovider/cloudprovider-alibaba-cloud.go
